Pod::Spec.new do |s|
	...
	s.source       = {:http => "https://cirepo.bs2dl.yy.com/sdks/ios/yyaudiosdk_mac/3.5.10/yyaudiosdk_mac.zip"}
	
	s.default_subspec = 'yyaudiosdk_mac'
	s.subspec 'yyaudiosdk_mac' do |ssm|
		ssm.dependency 'yyaudiocodec_mac', '1.2.1'
ssm.dependency 'yyaudiodsp_mac', '1.1.0'
    ...
    s.subspec 'yyaudiosdk_ai_mac' do |ssmai|
		ssmai.dependency 'audiodenoise/audiodenoise-macOS', '3.0.6'
ssmai.dependency 'yyaudiocodec_mac', '1.2.1'
ssmai.dependency 'yyaudiodsp_mac', '1.1.0'
