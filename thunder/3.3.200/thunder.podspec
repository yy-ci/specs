Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thunder/3.3.200/thunder.zip" }
...
full_static.dependency 'yyaudiosdk', '3.3.203'
full_static.dependency 'yydec265', '1.0.17'
full_static.dependency 'yyvideolib/yyvideolibsmallstatic_nobeauty', '100.33.9'
  ...
  s.subspec 'thunderbolt_baidu' do |baidu_static|
    ...
    baidu_static.dependency 'hydra/lite', '1.3.49'
...
fullai.dependency 'hydra/lite', '1.3.49'
...
fullai.dependency 'yyaudiosdk/yyaudiosdk_ai', '3.3.203'
fullai.dependency 'yydec265', '1.0.17'
fullai.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.33.9'
