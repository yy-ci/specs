Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thunder/3.3.206-3682-dev/thunder.zip" }
...
full.dependency 'hydra/lite', '1.3.403'
full.dependency 'jobase/jobase', '1.3.32'
full.dependency 'libyuv', '1.0.5'
full.dependency 'transengine/transengine-full', '3.3.201-1452-dev'
full.dependency 'yyaudiosdk', '3.3.206'
...
full_static.dependency 'transengine/transengine-full', '3.3.201-1452-dev'
full_static.dependency 'yyaudiosdk', '3.3.206'
...
full_static.dependency 'yyvideolib/yyvideolibsmallstatic_nobeauty', '100.33.10'
  ...
  s.subspec 'thunderbolt_baidu' do |baidu_static|
    ...
    baidu_static.dependency 'hydra/lite', '1.3.403'
baidu_static.dependency 'jobase/jobase', '1.3.32'
...
fullai.dependency 'hydra/lite', '1.3.403'
fullai.dependency 'jobase/jobase', '1.3.32'
fullai.dependency 'libyuv', '1.0.5'
fullai.dependency 'transengine/transengine-full', '3.3.201-1452-dev'
fullai.dependency 'yyaudiosdk/yyaudiosdk_ai', '3.3.206'
...
fullai.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.33.10'
  ...
  s.subspec 'thunder' do |audio|
    ...
    audio.dependency 'hydra/lite', '1.3.403'
audio.dependency 'jobase/jobase', '1.3.32'
audio.dependency 'transengine/transengine-audio', '3.3.201-1452-dev'
audio.dependency 'yyaudiosdk', '3.3.206'
  ...
  s.subspec 'thunder_ai' do |audioai|
    ...
    audioai.dependency 'hydra/lite', '1.3.403'
audioai.dependency 'jobase/jobase', '1.3.32'
audioai.dependency 'transengine/transengine-audio', '3.3.201-1452-dev'
audioai.dependency 'yyaudiosdk/yyaudiosdk_ai', '3.3.206'
