Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/hydra/1.4.0/hydra.zip" }
  s.requires_arc = true
...
sc.dependency 'jobase/jobase-full', '1.4.0'
...
sl.dependency 'jobase/jobase-lite', '1.4.0'
  end
...
sc_macOS.dependency 'jobase/jobase-mac-full', '1.4.0'
...
sl_macOS.dependency 'jobase/jobase-mac-lite', '1.4.0'
  end
end
