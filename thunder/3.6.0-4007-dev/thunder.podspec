Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thunder/3.6.0-4007-dev/thunder.zip" }
...
full.dependency 'jobase/jobase-lite', '1.6.0-257-dev'
full.dependency 'libyuv', '1.0.5'
full.dependency 'transengine/transengine-full', '3.6.0-1548-dev'
full.dependency 'yyaudiosdk', '3.6.0-292-dev'
full.dependency 'yydec265', '1.0.17'
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.17.4'
...
full_static.dependency 'transengine/transengine-full', '3.6.0-1548-dev'
full_static.dependency 'yyaudiosdk', '3.6.0-292-dev'
full_static.dependency 'yydec265', '1.0.17'
full_static.dependency 'yyvideolib/yyvideolibsmallstatic_nobeauty', '100.17.4'
  ...
  s.subspec 'thunderbolt_baidu' do |baidu_static|
    ...
    baidu_static.dependency 'jobase/jobase-lite', '1.6.0-257-dev'
  ...
  s.subspec 'thunderbolt_baidu_debug' do |baidu_static_debug|
    ...
    baidu_static_debug.dependency 'jobase/jobase-lite', '1.6.0-257-dev'
baidu_static_debug.dependency 'transengine/transengine-full', '3.6.0-1548-dev'
baidu_static_debug.dependency 'yy264', '1.0.18'
baidu_static_debug.dependency 'yyaudiosdk/yyaudiosdk_bd', '3.6.0-292-dev'
baidu_static_debug.dependency 'yydec265', '1.0.17'
baidu_static_debug.dependency 'yyvideolib/yyvideolibstatic_bdsmall', '100.17.4'
...
fullai.dependency 'jobase/jobase-lite', '1.6.0-257-dev'
fullai.dependency 'libyuv', '1.0.5'
fullai.dependency 'transengine/transengine-full', '3.6.0-1548-dev'
fullai.dependency 'yyaudiosdk/yyaudiosdk_ai', '3.6.0-292-dev'
fullai.dependency 'yydec265', '1.0.17'
fullai.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.17.4'
  ...
  s.subspec 'thunder' do |audio|
    ...
    audio.dependency 'jobase/jobase-lite', '1.6.0-257-dev'
audio.dependency 'transengine/transengine-audio', '3.6.0-1548-dev'
audio.dependency 'yyaudiosdk', '3.6.0-292-dev'
  ...
  s.subspec 'thunder_ai' do |audioai|
    ...
    audioai.dependency 'jobase/jobase-lite', '1.6.0-257-dev'
audioai.dependency 'transengine/transengine-audio', '3.6.0-1548-dev'
audioai.dependency 'yyaudiosdk/yyaudiosdk_ai', '3.6.0-292-dev'
