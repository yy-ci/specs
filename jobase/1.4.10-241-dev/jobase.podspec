Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/jobase/1.4.10-241-dev/jobase.zip" }
  ...
  s.subspec 'jobase-full' do |ios_full|
    ...
    ios_full.dependency 'openssl-medusatrans', '111.6729.0'
  ...
  s.subspec 'jobase-mac-full' do |mac_full|
    ...
    mac_full.dependency 'opensslOSX', '111.8.0'
