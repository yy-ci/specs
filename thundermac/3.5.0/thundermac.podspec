Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thundermac/3.5.0/thundermac.zip" }
  ...
  s.subspec 'thunderboltmac' do |full|
    ...
    full.dependency 'hydra/lite_macOS', '1.4.0'
full.dependency 'jobase/jobase-mac-lite', '1.4.0'
full.dependency 'transengine/transengine-full-macOS', '3.5.0'
full.dependency 'yyaudiosdk_mac', '3.5.0'
full.dependency 'yyvideolibmac', '1.0.50'
  ...
  s.subspec 'thunderboltmacai' do |fullai|
    ...
    fullai.dependency 'hydra/lite_macOS', '1.4.0'
fullai.dependency 'jobase/jobase-mac-lite', '1.4.0'
fullai.dependency 'transengine/transengine-full-macOS', '3.5.0'
fullai.dependency 'yyaudiosdk_mac/yyaudiosdk_ai_mac', '3.5.0'
fullai.dependency 'yyvideolibmac', '1.0.50'
  ...
  s.subspec 'thunderboltyymac' do |fullyy|
    ...
    fullyy.dependency 'hydra/lite_macOS', '1.4.0'
fullyy.dependency 'jobase/jobase-mac-lite', '1.4.0'
fullyy.dependency 'transengine/transengine-full-macOS', '3.5.0'
fullyy.dependency 'yyaudiosdk_mac', '3.5.0'
fullyy.dependency 'yyvideolibmac', '1.0.50'
  ...
  s.subspec 'thunderboltyymacai' do |fullyyai|
    ...
    fullyyai.dependency 'hydra/lite_macOS', '1.4.0'
fullyyai.dependency 'jobase/jobase-mac-lite', '1.4.0'
fullyyai.dependency 'transengine/transengine-full-macOS', '3.5.0'
fullyyai.dependency 'yyaudiosdk_mac/yyaudiosdk_ai_mac', '3.5.0'
fullyyai.dependency 'yyvideolibmac', '1.0.50'
