Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/hydra/1.4.10/hydra.zip" }
  s.requires_arc = true
  ...
  s.subspec 'hydra' do |sc| 
    ...
    sc.dependency 'jobase/jobase-full', '1.4.10'
sc.dependency 'openssl-medusatrans', '111.6729.0'
  ...
  s.subspec 'lite' do |sl| 
    ...
    sl.dependency 'jobase/jobase-lite', '1.4.10'
  end
  ...
  s.subspec 'hydra_macOS' do |sc_macOS| 
    ...
    sc_macOS.dependency 'jobase/jobase-mac-full', '1.4.10'
sc_macOS.dependency 'opensslOSX', '111.8.0'
  ...
  s.subspec 'lite_macOS' do |sl_macOS| 
    ...
    sl_macOS.dependency 'jobase/jobase-mac-lite', '1.4.10'
  end
end
