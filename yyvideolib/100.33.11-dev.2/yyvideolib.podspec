Pod::Spec.new do |s|
	...
	s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/yyvideolib/100.33.11-dev.2/yyvideolib.zip" }
    s.requires_arc = true
	...
	s.subspec 'yyvideolibstatic_nobeauty' do |sv|
        ...
        s.subspec 'yyvideolibstatic_bdsmall' do |scbd|
                        scbd.source_files = 'include/yyvideolibstatic_bdsmall/*.h'
                        scbd.resource = 'resource/yyvideolibstatic_bdsmall/yyvideolib.bundle'
                        scbd.vendored_library = 'libs/libyyvideolibstatic_bdsmall.a'
                        scbd.library = 'yyvideolibstatic_bdsmall'
                        scbd.xcconfig = { 'LIBRARY_SEARCH_PATHS' => '"$(PODS_ROOT)/yyvideolib/libs"' }
        end
