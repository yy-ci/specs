Pod::Spec.new do |s|
	...
	s.source       = {:http => "https://cirepo.bs2dl.yy.com/sdks/ios/yyaudiosdk/3.3.205/yyaudiosdk.zip"}
	
	s.default_subspec = 'yyaudiosdk'
	s.subspec 'yyaudiosdk' do |ss|
		ss.dependency 'yyaudiocodec', '1.2.1'
...
ssai.dependency 'yyaudiocodec', '1.2.1'
ssai.dependency 'yyaudiodsp', '1.0.200'
	...
	s.subspec 'yyaudiosdk_bd' do |ss_bd|
		ss_bd.dependency 'yyaudiocodec/yyaudiocodec_bd', '1.2.1'
