Pod::Spec.new do |s|
	...
	s.source       = {:http => "https://cirepo.bs2dl.yy.com/sdks/ios/yyaudiosdk/3.3.208-dev/yyaudiosdk.zip"}
	
	s.default_subspec = 'yyaudiosdk'
	s.subspec 'yyaudiosdk' do |ss|
		ss.dependency 'yyaudiocodec', '1.2.2'
ss.dependency 'yyaudiodsp', '1.0.201-dev'
...
ssai.dependency 'yyaudiocodec', '1.2.2'
ssai.dependency 'yyaudiodsp', '1.0.201-dev'
	...
	s.subspec 'yyaudiosdk_bd' do |ss_bd|
		ss_bd.dependency 'yyaudiocodec/yyaudiocodec_bd', '1.2.2'
ss_bd.dependency 'yyaudiodsp', '1.0.201-dev'
