Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/transengine/3.5.0/transengine.zip" }
  ...
  s.subspec 'transengine-full' do |full|
    ...
    full.dependency 'jobase/jobase-lite', '1.4.0'
  ...
  s.subspec 'transengine-audio' do |audio|
    ...
    audio.dependency 'jobase/jobase-lite', '1.4.0'
  ...
  s.subspec 'transengine-full-macOS' do |fullmac|
    ...
    fullmac.dependency 'jobase/jobase-mac-lite', '1.4.0'
  ...
  s.subspec 'transengine-audio-macOS' do |audiomac|
    ...
    audiomac.dependency 'jobase/jobase-mac-lite', '1.4.0'
