Pod::Spec.new do |s|
	...
	s.source       = {:http => "https://cirepo.bs2dl.yy.com/sdks/ios/yyaudiosdk/3.5.0/yyaudiosdk.zip"}
	
	s.default_subspec = 'yyaudiosdk'
	s.subspec 'yyaudiosdk' do |ss|
		ss.dependency 'yyaudiocodec', '1.1.2'
ss.dependency 'yyaudiodsp', '1.0.0'
    ...
    s.subspec 'yyaudiosdk_ai' do |ssai|
		ssai.dependency 'audiodenoise/audiodenoise-iOS', '3.0.7'
ssai.dependency 'yyaudiocodec', '1.1.2'
