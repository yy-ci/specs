Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/hydra/1.3.60-454-dev/hydra.zip" }
  s.requires_arc = true
  ...
  s.subspec 'hydra' do |sc| 
    ...
    sc.dependency 'openssl', '102106.6747.0'
  end
  ...
  s.subspec 'lite' do |sl| 
    ...
    sl.dependency 'jobase/jobase', '1.3.33'
  end
  ...
  s.subspec 'hydra_macOS' do |sc_macOS| 
    ...
    sc_macOS.dependency 'jobase/jobase-mac', '1.3.33'
sc_macOS.dependency 'opensslOSX', '111.8.0'
  ...
  s.subspec 'lite_macOS' do |sl_macOS| 
    ...
    sl_macOS.dependency 'jobase/jobase-mac', '1.3.33'
  end
end
