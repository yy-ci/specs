Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thunder/3.3.305-4156-dev/thunder.zip" }
...
full.dependency 'jobase/jobase', '1.3.61'
full.dependency 'libyuv', '1.0.5'
full.dependency 'transengine/transengine-full', '3.3.303'
full.dependency 'yyaudiosdk', '3.3.301'
...
full_static.dependency 'transengine/transengine-full', '3.3.303'
full_static.dependency 'yyaudiosdk', '3.3.301'
...
full_static.dependency 'yyvideolib/yyvideolibsmallstatic_nobeauty', '100.33.19'
  ...
  s.subspec 'thunderbolt_baidu' do |baidu_static|
    ...
    baidu_static.dependency 'jobase/jobase', '1.3.61'
...
fullai.dependency 'jobase/jobase', '1.3.61'
fullai.dependency 'libyuv', '1.0.5'
fullai.dependency 'transengine/transengine-full', '3.3.303'
fullai.dependency 'yyaudiosdk/yyaudiosdk_ai', '3.3.301'
...
fullai.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.33.19'
  ...
  s.subspec 'thunder' do |audio|
    ...
    audio.dependency 'jobase/jobase', '1.3.61'
audio.dependency 'transengine/transengine-audio', '3.3.303'
audio.dependency 'yyaudiosdk', '3.3.301'
  ...
  s.subspec 'thunder_ai' do |audioai|
    ...
    audioai.dependency 'jobase/jobase', '1.3.61'
audioai.dependency 'transengine/transengine-audio', '3.3.303'
audioai.dependency 'yyaudiosdk/yyaudiosdk_ai', '3.3.301'
