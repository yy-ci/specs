Pod::Spec.new do |s|
  ...
  s.source = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/transengine/3.7.0-1597-dev/transengine.zip" }
  ...
  s.subspec 'transengine-full-macOS' do |fullmac|
    ...
    fullmac.dependency 'jobase/jobase-mac-lite', '1.7.0-280-dev'
  ...
  s.subspec 'transengine-audio-macOS' do |audiomac|
    ...
    audiomac.dependency 'jobase/jobase-mac-lite', '1.7.0-280-dev'
