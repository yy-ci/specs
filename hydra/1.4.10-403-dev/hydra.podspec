Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/hydra/1.4.10-403-dev/hydra.zip" }
  s.requires_arc = true
  ...
  s.subspec 'hydra' do |sc| 
    ...
    sc.dependency 'jobase/jobase-full', '1.4.10-241-dev'
sc.dependency 'openssl-medusatrans', '111.6729.0'
  ...
  s.subspec 'lite' do |sl| 
    ...
    sl.dependency 'jobase/jobase-lite', '1.4.10-241-dev'
  end
  ...
  s.subspec 'hydra_macOS' do |sc_macOS| 
    ...
    sc_macOS.dependency 'jobase/jobase-mac-full', '1.4.10-241-dev'
sc_macOS.dependency 'opensslOSX', '111.8.0'
  ...
  s.subspec 'lite_macOS' do |sl_macOS| 
    ...
    sl_macOS.dependency 'jobase/jobase-mac-lite', '1.4.10-241-dev'
  end
end
