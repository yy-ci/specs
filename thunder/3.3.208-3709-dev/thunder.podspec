Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thunder/3.3.208-3709-dev/thunder.zip" }
...
full.dependency 'hydra/lite', '1.3.404-423-dev'
full.dependency 'jobase/jobase', '1.3.32-244-dev'
full.dependency 'libyuv', '1.0.5'
full.dependency 'transengine/transengine-full', '3.3.200-1463-dev'
full.dependency 'yyaudiosdk', '3.3.208-dev'
full.dependency 'yydec265', '1.0.17'
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.33.10'
...
full_static.dependency 'transengine/transengine-full', '3.3.200-1463-dev'
full_static.dependency 'yyaudiosdk', '3.3.208-dev'
full_static.dependency 'yydec265', '1.0.17'
full_static.dependency 'yyvideolib/yyvideolibsmallstatic_nobeauty', '100.33.10'
  ...
  s.subspec 'thunderbolt_baidu' do |baidu_static|
    ...
    baidu_static.dependency 'hydra/lite', '1.3.404-423-dev'
baidu_static.dependency 'jobase/jobase', '1.3.32-244-dev'
...
fullai.dependency 'hydra/lite', '1.3.404-423-dev'
fullai.dependency 'jobase/jobase', '1.3.32-244-dev'
fullai.dependency 'libyuv', '1.0.5'
fullai.dependency 'transengine/transengine-full', '3.3.200-1463-dev'
fullai.dependency 'yyaudiosdk/yyaudiosdk_ai', '3.3.208-dev'
fullai.dependency 'yydec265', '1.0.17'
fullai.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.33.10'
  ...
  s.subspec 'thunder' do |audio|
    ...
    audio.dependency 'hydra/lite', '1.3.404-423-dev'
audio.dependency 'jobase/jobase', '1.3.32-244-dev'
audio.dependency 'transengine/transengine-audio', '3.3.200-1463-dev'
audio.dependency 'yyaudiosdk', '3.3.208-dev'
  ...
  s.subspec 'thunder_ai' do |audioai|
    ...
    audioai.dependency 'hydra/lite', '1.3.404-423-dev'
audioai.dependency 'jobase/jobase', '1.3.32-244-dev'
audioai.dependency 'transengine/transengine-audio', '3.3.200-1463-dev'
audioai.dependency 'yyaudiosdk/yyaudiosdk_ai', '3.3.208-dev'
