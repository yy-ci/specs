Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thunder/3.3.212-3955-dev/thunder.zip" }
...
full.dependency 'hydra/lite', '1.3.409'
...
full_static.dependency 'yyvideolib/yyvideolibsmallstatic_nobeauty', '100.33.14'
  ...
  s.subspec 'thunderbolt_baidu' do |baidu_static|
    ...
    baidu_static.dependency 'hydra/lite', '1.3.409'
...
fullai.dependency 'hydra/lite', '1.3.409'
...
fullai.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.33.14'
  ...
  s.subspec 'thunder' do |audio|
    ...
    audio.dependency 'hydra/lite', '1.3.409'
...
audio.dependency 'yyaudiosdk', '3.3.208'
  ...
  s.subspec 'thunder_ai' do |audioai|
    ...
    audioai.dependency 'hydra/lite', '1.3.409'
