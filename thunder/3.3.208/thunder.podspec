Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thunder/3.3.208/thunder.zip" }
...
full.dependency 'hydra/lite', '1.3.404'
full.dependency 'jobase/jobase', '1.3.33'
full.dependency 'libyuv', '1.0.5'
full.dependency 'transengine/transengine-full', '3.3.201'
...
full_static.dependency 'transengine/transengine-full', '3.3.201'
...
full_static.dependency 'yyvideolib/yyvideolibsmallstatic_nobeauty', '100.33.10'
  ...
  s.subspec 'thunderbolt_baidu' do |baidu_static|
    ...
    baidu_static.dependency 'hydra/lite', '1.3.404'
...
fullai.dependency 'hydra/lite', '1.3.404'
fullai.dependency 'jobase/jobase', '1.3.33'
fullai.dependency 'libyuv', '1.0.5'
fullai.dependency 'transengine/transengine-full', '3.3.201'
...
fullai.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.33.10'
  ...
  s.subspec 'thunder' do |audio|
    ...
    audio.dependency 'hydra/lite', '1.3.404'
audio.dependency 'jobase/jobase', '1.3.33'
audio.dependency 'transengine/transengine-audio', '3.3.201'
audio.dependency 'yyaudiosdk', '3.3.208'
  ...
  s.subspec 'thunder_ai' do |audioai|
    ...
    audioai.dependency 'hydra/lite', '1.3.404'
audioai.dependency 'jobase/jobase', '1.3.33'
audioai.dependency 'transengine/transengine-audio', '3.3.201'
