Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thunder/3.3.208-3710-dev/thunder.zip" }
...
full.dependency 'hydra/lite', '1.3.404-424-dev'
...
full_static.dependency 'yyvideolib/yyvideolibsmallstatic_nobeauty', '100.33.10'
  ...
  s.subspec 'thunderbolt_baidu' do |baidu_static|
    ...
    baidu_static.dependency 'hydra/lite', '1.3.404-424-dev'
...
fullai.dependency 'hydra/lite', '1.3.404-424-dev'
...
fullai.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.33.10'
  ...
  s.subspec 'thunder' do |audio|
    ...
    audio.dependency 'hydra/lite', '1.3.404-424-dev'
...
audio.dependency 'yyaudiosdk', '3.3.208-dev'
  ...
  s.subspec 'thunder_ai' do |audioai|
    ...
    audioai.dependency 'hydra/lite', '1.3.404-424-dev'
