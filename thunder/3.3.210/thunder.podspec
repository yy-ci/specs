Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thunder/3.3.210/thunder.zip" }
...
full.dependency 'hydra/lite', '1.3.407'
...
full_static.dependency 'yyvideolib/yyvideolibsmallstatic_nobeauty', '100.33.10'
  ...
  s.subspec 'thunderbolt_baidu' do |baidu_static|
    ...
    baidu_static.dependency 'hydra/lite', '1.3.407'
...
fullai.dependency 'hydra/lite', '1.3.407'
...
fullai.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.33.10'
  ...
  s.subspec 'thunder' do |audio|
    ...
    audio.dependency 'hydra/lite', '1.3.407'
...
audio.dependency 'yyaudiosdk', '3.3.208'
  ...
  s.subspec 'thunder_ai' do |audioai|
    ...
    audioai.dependency 'hydra/lite', '1.3.407'
