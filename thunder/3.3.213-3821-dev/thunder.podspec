Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thunder/3.3.213-3821-dev/thunder.zip" }
...
full.dependency 'hydra', '1.3.60-454-dev'
...
full_static.dependency 'yyvideolib/yyvideolibsmallstatic_nobeauty', '100.33.14'
  ...
  s.subspec 'thunderbolt_baidu' do |baidu_static|
    ...
    baidu_static.dependency 'hydra', '1.3.60-454-dev'
...
fullai.dependency 'hydra', '1.3.60-454-dev'
...
fullai.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.33.14'
  ...
  s.subspec 'thunder' do |audio|
    ...
    audio.dependency 'hydra', '1.3.60-454-dev'
...
audio.dependency 'yyaudiosdk', '3.3.208'
  ...
  s.subspec 'thunder_ai' do |audioai|
    ...
    audioai.dependency 'hydra', '1.3.60-454-dev'
