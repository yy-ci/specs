Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thunder/3.3.300-3965-dev/thunder.zip" }
...
full.dependency 'jobase/jobase', '1.3.60'
full.dependency 'libyuv', '1.0.5'
full.dependency 'transengine/transengine-full', '3.3.300'
full.dependency 'yyaudiosdk', '3.3.300'
...
full_static.dependency 'transengine/transengine-full', '3.3.300'
full_static.dependency 'yyaudiosdk', '3.3.300'
...
full_static.dependency 'yyvideolib/yyvideolibsmallstatic_nobeauty', '100.33.18'
  ...
  s.subspec 'thunderbolt_baidu' do |baidu_static|
    ...
    baidu_static.dependency 'jobase/jobase', '1.3.60'
...
fullai.dependency 'jobase/jobase', '1.3.60'
fullai.dependency 'libyuv', '1.0.5'
fullai.dependency 'transengine/transengine-full', '3.3.300'
fullai.dependency 'yyaudiosdk/yyaudiosdk_ai', '3.3.300'
...
fullai.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.33.18'
  ...
  s.subspec 'thunder' do |audio|
    ...
    audio.dependency 'jobase/jobase', '1.3.60'
audio.dependency 'transengine/transengine-audio', '3.3.300'
audio.dependency 'yyaudiosdk', '3.3.300'
  ...
  s.subspec 'thunder_ai' do |audioai|
    ...
    audioai.dependency 'jobase/jobase', '1.3.60'
audioai.dependency 'transengine/transengine-audio', '3.3.300'
audioai.dependency 'yyaudiosdk/yyaudiosdk_ai', '3.3.300'
