Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thunder/3.5.10-3664-dev/thunder.zip" }
...
full.dependency 'hydra/lite', '1.4.10-403-dev'
full.dependency 'jobase/jobase-lite', '1.4.10-241-dev'
full.dependency 'libyuv', '1.0.5'
full.dependency 'transengine/transengine-full', '3.5.10-1444-dev'
full.dependency 'yyaudiosdk', '3.5.10-223-dev'
full.dependency 'yydec265', '1.0.17'
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.14.1-dev.6'
...
full_static.dependency 'transengine/transengine-full', '3.5.10-1444-dev'
full_static.dependency 'yyaudiosdk', '3.5.10-223-dev'
full_static.dependency 'yydec265', '1.0.17'
full_static.dependency 'yyvideolib/yyvideolibsmallstatic_nobeauty', '100.14.1-dev.6'
  ...
  s.subspec 'thunderbolt_baidu' do |baidu_static|
    ...
    baidu_static.dependency 'hydra/lite', '1.4.10-403-dev'
baidu_static.dependency 'jobase/jobase-lite', '1.4.10-241-dev'
...
fullai.dependency 'hydra/lite', '1.4.10-403-dev'
fullai.dependency 'jobase/jobase-lite', '1.4.10-241-dev'
fullai.dependency 'libyuv', '1.0.5'
fullai.dependency 'transengine/transengine-full', '3.5.10-1444-dev'
fullai.dependency 'yyaudiosdk/yyaudiosdk_ai', '3.5.10-223-dev'
fullai.dependency 'yydec265', '1.0.17'
fullai.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.14.1-dev.6'
  ...
  s.subspec 'thunder' do |audio|
    ...
    audio.dependency 'hydra/lite', '1.4.10-403-dev'
audio.dependency 'jobase/jobase-lite', '1.4.10-241-dev'
audio.dependency 'transengine/transengine-audio', '3.5.10-1444-dev'
audio.dependency 'yyaudiosdk', '3.5.10-223-dev'
  ...
  s.subspec 'thunder_ai' do |audioai|
    ...
    audioai.dependency 'hydra/lite', '1.4.10-403-dev'
audioai.dependency 'jobase/jobase-lite', '1.4.10-241-dev'
audioai.dependency 'transengine/transengine-audio', '3.5.10-1444-dev'
audioai.dependency 'yyaudiosdk/yyaudiosdk_ai', '3.5.10-223-dev'
