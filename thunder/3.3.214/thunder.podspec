Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thunder/3.3.214/thunder.zip" }
...
full.dependency 'hydra/lite', '1.3.410'
full.dependency 'jobase/jobase', '1.3.34'
full.dependency 'libyuv', '1.0.5'
full.dependency 'transengine/transengine-full', '3.3.204'
full.dependency 'yyaudiosdk', '3.3.208'
full.dependency 'yydec265', '1.0.17'
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.33.15'
...
full_static.dependency 'transengine/transengine-full', '3.3.204'
full_static.dependency 'yyaudiosdk', '3.3.208'
full_static.dependency 'yydec265', '1.0.17'
full_static.dependency 'yyvideolib/yyvideolibsmallstatic_nobeauty', '100.33.15'
  ...
  s.subspec 'thunderbolt_baidu' do |baidu_static|
    ...
    baidu_static.dependency 'hydra/lite', '1.3.410'
...
fullai.dependency 'hydra/lite', '1.3.410'
fullai.dependency 'jobase/jobase', '1.3.34'
fullai.dependency 'libyuv', '1.0.5'
fullai.dependency 'transengine/transengine-full', '3.3.204'
fullai.dependency 'yyaudiosdk/yyaudiosdk_ai', '3.3.208'
fullai.dependency 'yydec265', '1.0.17'
fullai.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.33.15'
  ...
  s.subspec 'thunder' do |audio|
    ...
    audio.dependency 'hydra/lite', '1.3.410'
audio.dependency 'jobase/jobase', '1.3.34'
audio.dependency 'transengine/transengine-audio', '3.3.204'
audio.dependency 'yyaudiosdk', '3.3.208'
  ...
  s.subspec 'thunder_ai' do |audioai|
    ...
    audioai.dependency 'hydra/lite', '1.3.410'
audioai.dependency 'jobase/jobase', '1.3.34'
audioai.dependency 'transengine/transengine-audio', '3.3.204'
