Pod::Spec.new do |s|
	...
	s.source       = {:http => "https://cirepo.bs2dl.yy.com/sdks/ios/yyaudiosdk/3.3.212-dev/yyaudiosdk.zip"}
	
	s.default_subspec = 'yyaudiosdk'
	s.subspec 'yyaudiosdk' do |ss|
		ss.dependency 'yyaudiocodec', '1.2.3'
ss.dependency 'yyaudiodsp', '1.0.202'
...
ssai.dependency 'yyaudiocodec', '1.2.3'
ssai.dependency 'yyaudiodsp', '1.0.202'
	...
	s.subspec 'yyaudiosdk_bd' do |ss_bd|
		ss_bd.dependency 'yyaudiocodec/yyaudiocodec_bd', '1.2.3'
ss_bd.dependency 'yyaudiodsp', '1.0.202'
...
ss_bd_ai.dependency 'yyaudiocodec/yyaudiocodec_bd', '1.2.3'
ss_bd_ai.dependency 'yyaudiodsp', '1.0.202'
