Pod::Spec.new do |s|
        ...
        s.source                = {:http =>"https://cirepo.bs2dl.yy.com/sdks/ios/venus/1.8.68-bitcode/venus.zip"}
        ...
        s.subspec 'venus-yy-static-nopalm32' do |ss18|
                ss18.xcconfig              = {'HEADER_SEARCH_PATHS' => '${PODS_ROOT}/venus/include','LIBRARY_SEARCH_PATHS' => "${PODS_ROOT}/venus/libs" }
                ss18.source_files         = 'include/**/*.h'
                ss18.preserve_paths       = 'libs/**/*.a'
                ss18.libraries            = 'vn_core_static', 'vn_cnn_static', 'vn_kits_static', 'vn_resources_static', 'vn_gesture_static', 'vn_seg_static', 'vn_sbseg_static', 'vn_bodylandmark_static', 'vn_face_static', 'vn_asr_static', 'vn_hairseg_static','vn_skyseg_static','vn_clothesseg_static','vn_new_gesture_static','vn_seg_static'
                ss18.vendored_frameworks     = 'Accelerate.framework/Accelerate.tbd'
                ss18.ios.vendored_libraries =  'libs/libvenus_static.a', 'libs/libvn_asr_static.a', 'libs/libvn_audiodenoise_static.a', 'libs/libvn_bodylandmark_static.a', 'libs/libvn_clothesseg_static.a', 'libs/libvn_cnn_static.a', 'libs/libvn_core_static.a', 'libs/libvn_face_static.a', 'libs/libvn_gesture_static.a', 'libs/libvn_hairseg_static.a', 'libs/libvn_headseg_static.a', 'libs/libvn_kits_static.a', 'libs/libvn_new_gesture_static.a', 'libs/libvn_resources_static.a', 'libs/libvn_sbseg_static.a', 'libs/libvn_seg_static.a', 'libs/libvn_singodenoise_static.a', 'libs/libvn_skyseg_static.a','c++'
        end
        ...
        s.subspec 'venus-all-static2' do |ss32|
                ...
                ss32.libraries            = 'vn_core_static', 'vn_cnn_static', 'vn_kits_static', 'vn_resources_static', 'vn_gesture_static', 'vn_seg_static', 'vn_sbseg_static', 'vn_bodylandmark_static', 'vn_face_static', 'vn_asr_static', 'vn_hairseg_static','vn_skyseg_static','vn_clothesseg_static','vn_new_gesture_static','vn_seg_static'
        ...
        s.subspec 'venus-core-static-2b' do |ss36|
                ss36.xcconfig               = {'HEADER_SEARCH_PATHS' => '${PODS_ROOT}/venus/include','LIBRARY_SEARCH_PATHS' => "${PODS_ROOT}/venus/libs", "GCC_PREPROCESSOR_DEFINITIONS" => '$(inherited) USE_VENUS=1' }
                ss36.source_files           = 'include/**/*.h'
                ss36.preserve_paths         = 'libs/**/*.a'
                ss36.libraries              = 'vn_core_static', 'vn_cnn_static', 'vn_kits_static', 'vn_resources_static'
                ss36.vendored_frameworks    = 'Accelerate.framework/Accelerate.tbd'
                ss36.ios.vendored_libraries = 'libs/*.a','c++'
        end

        s.subspec 'venus-resources-static-2b' do |ss35|
                ss35.xcconfig              = {'HEADER_SEARCH_PATHS' => '${PODS_ROOT}/venus/include','LIBRARY_SEARCH_PATHS' => "${PODS_ROOT}/venus/libs" }
                ss35.source_files          = 'include/**/*.h'
                ss35.preserve_paths        = 'libs/**/*.a'
                ss35.libraries              = 'vn_resources_static'
                ss35.vendored_frameworks    = 'Accelerate.framework/Accelerate.tbd'
                ss35.ios.resource_bundle = { "vn_resources" => "libs/vn_resources.framework/default.metallib" }
        end

        s.subspec 'venus-face-static-2b' do |ss37|
                ss37.xcconfig               = {'HEADER_SEARCH_PATHS' => '${PODS_ROOT}/venus/include','LIBRARY_SEARCH_PATHS' => "${PODS_ROOT}/venus/libs" }
                ss37.source_files           = 'include/**/*.h'
                ss37.preserve_paths         = 'libs/**/*.a'
                ss37.libraries              = 'vn_face_static'
                ss37.vendored_frameworks    = 'Accelerate.framework/Accelerate.tbd'
                ss37.ios.vendored_libraries = 'libs/*.a','c++'
        end

        s.subspec 'venus-vad-static-2b' do |ss38|
                ss38.xcconfig               = {'HEADER_SEARCH_PATHS' => '${PODS_ROOT}/venus/include','LIBRARY_SEARCH_PATHS' => "${PODS_ROOT}/venus/libs" }
                ss38.source_files           = 'include/**/*.h'
                ss38.preserve_paths         = 'libs/**/*.a'
                ss38.libraries              = 'vn_vad_static'
                ss38.vendored_frameworks    = 'Accelerate.framework/Accelerate.tbd'
                ss38.ios.vendored_libraries = 'libs/*.a','c++'
        end

        s.subspec 'venus-gesture2-static-2b' do |ss39|
                ss39.xcconfig               = {'HEADER_SEARCH_PATHS' => '${PODS_ROOT}/venus/include','LIBRARY_SEARCH_PATHS' => "${PODS_ROOT}/venus/libs" }
                ss39.source_files           = 'include/**/*.h'
                ss39.preserve_paths         = 'libs/**/*.a'
                ss39.libraries              = 'vn_new_gesture_static'
                ss39.vendored_frameworks    = 'Accelerate.framework/Accelerate.tbd'
                ss39.ios.vendored_libraries = 'libs/*.a','c++'
        end

        s.subspec 'venus-seg-static-2b' do |ss40|
                ss40.xcconfig               = {'HEADER_SEARCH_PATHS' => '${PODS_ROOT}/venus/include','LIBRARY_SEARCH_PATHS' => "${PODS_ROOT}/venus/libs" }
                ss40.source_files           = 'include/**/*.h'
                ss40.preserve_paths         = 'libs/**/*.a'
                ss40.libraries              = 'vn_seg_static'
                ss40.vendored_frameworks    = 'Accelerate.framework/Accelerate.tbd'
                ss40.ios.vendored_libraries = 'libs/*.a','c++'
        end

        s.subspec 'venus-faceparsing-static-2b' do |ss41|
                ss41.xcconfig               = {'HEADER_SEARCH_PATHS' => '${PODS_ROOT}/venus/include','LIBRARY_SEARCH_PATHS' => "${PODS_ROOT}/venus/libs" }
                ss41.source_files           = 'include/**/*.h'
                ss41.preserve_paths         = 'libs/**/*.a'
                ss41.libraries              = 'vn_faceparsing_static'
                ss41.vendored_frameworks    = 'Accelerate.framework/Accelerate.tbd'
                ss41.ios.vendored_libraries = 'libs/*.a','c++'
        end
end
