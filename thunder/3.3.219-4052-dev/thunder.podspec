Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thunder/3.3.219-4052-dev/thunder.zip" }
...
full.dependency 'transengine/transengine-full', '3.3.208'
full.dependency 'yyaudiosdk', '3.3.212-dev'
full.dependency 'yydec265', '1.0.17'
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.33.19-dev.6'
...
full_static.dependency 'transengine/transengine-full', '3.3.208'
full_static.dependency 'yyaudiosdk', '3.3.212-dev'
full_static.dependency 'yydec265', '1.0.17'
full_static.dependency 'yyvideolib/yyvideolibsmallstatic_nobeauty', '100.33.19-dev.6'
...
fullai.dependency 'transengine/transengine-full', '3.3.208'
fullai.dependency 'yyaudiosdk/yyaudiosdk_ai', '3.3.212-dev'
fullai.dependency 'yydec265', '1.0.17'
fullai.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.33.19-dev.6'
...
audio.dependency 'transengine/transengine-audio', '3.3.208'
audio.dependency 'yyaudiosdk', '3.3.212-dev'
...
audioai.dependency 'transengine/transengine-audio', '3.3.208'
audioai.dependency 'yyaudiosdk/yyaudiosdk_ai', '3.3.212-dev'
