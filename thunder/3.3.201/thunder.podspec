Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thunder/3.3.201/thunder.zip" }
...
full.dependency 'hydra/lite', '1.3.401'
full.dependency 'jobase/jobase', '1.3.30'
full.dependency 'libyuv', '1.0.5'
full.dependency 'transengine/transengine-full', '3.3.200'
full.dependency 'yyaudiosdk', '3.3.204'
...
full_static.dependency 'yyaudiosdk', '3.3.204'
...
full_static.dependency 'yyvideolib/yyvideolibsmallstatic_nobeauty', '100.33.10'
  ...
  s.subspec 'thunderbolt_baidu' do |baidu_static|
    ...
    baidu_static.dependency 'hydra/lite', '1.3.401'
baidu_static.dependency 'jobase/jobase', '1.3.30'
...
fullai.dependency 'hydra/lite', '1.3.401'
fullai.dependency 'jobase/jobase', '1.3.30'
fullai.dependency 'libyuv', '1.0.5'
fullai.dependency 'transengine/transengine-full', '3.3.200'
fullai.dependency 'yyaudiosdk/yyaudiosdk_ai', '3.3.204'
...
fullai.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.33.10'
  ...
  s.subspec 'thunder' do |audio|
    ...
    audio.dependency 'hydra/lite', '1.3.401'
audio.dependency 'jobase/jobase', '1.3.30'
audio.dependency 'transengine/transengine-audio', '3.3.200'
audio.dependency 'yyaudiosdk', '3.3.204'
  ...
  s.subspec 'thunder_ai' do |audioai|
    ...
    audioai.dependency 'hydra/lite', '1.3.401'
audioai.dependency 'jobase/jobase', '1.3.30'
audioai.dependency 'transengine/transengine-audio', '3.3.200'
audioai.dependency 'yyaudiosdk/yyaudiosdk_ai', '3.3.204'
