Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thunder/3.3.219-3980-dev/thunder.zip" }
...
full.dependency 'hydra/lite', '1.3.461'
full.dependency 'jobase/jobase', '1.3.34'
full.dependency 'libyuv', '1.0.5'
full.dependency 'transengine/transengine-full', '3.3.207'
full.dependency 'yyaudiosdk', '3.3.211'
full.dependency 'yydec265', '1.0.17'
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.33.18'
...
full_static.dependency 'transengine/transengine-full', '3.3.207'
full_static.dependency 'yyaudiosdk', '3.3.211'
full_static.dependency 'yydec265', '1.0.17'
full_static.dependency 'yyvideolib/yyvideolibsmallstatic_nobeauty', '100.33.18'
  ...
  s.subspec 'thunderbolt_baidu' do |baidu_static|
    ...
    baidu_static.dependency 'hydra/lite', '1.3.461'
baidu_static.dependency 'jobase/jobase', '1.3.34'
  ...
  s.subspec 'thunderbolt_baidu_debug' do |baidu_static_debug|
    ...
    baidu_static_debug.dependency 'hydra/lite', '1.3.461'
baidu_static_debug.dependency 'jobase/jobase', '1.3.34'
baidu_static_debug.dependency 'transengine/transengine-full', '3.3.207'
baidu_static_debug.dependency 'yy264', '1.0.17'
baidu_static_debug.dependency 'yyaudiosdk/yyaudiosdk_bd', '3.3.211'
baidu_static_debug.dependency 'yydec265', '1.0.17'
baidu_static_debug.dependency 'yyvideolib/yyvideolibstatic_bdsmall', '100.33.18'
...
fullai.dependency 'hydra/lite', '1.3.461'
fullai.dependency 'jobase/jobase', '1.3.34'
fullai.dependency 'libyuv', '1.0.5'
fullai.dependency 'transengine/transengine-full', '3.3.207'
fullai.dependency 'yyaudiosdk/yyaudiosdk_ai', '3.3.211'
fullai.dependency 'yydec265', '1.0.17'
fullai.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.33.18'
  ...
  s.subspec 'thunder' do |audio|
    ...
    audio.dependency 'hydra/lite', '1.3.461'
audio.dependency 'jobase/jobase', '1.3.34'
audio.dependency 'transengine/transengine-audio', '3.3.207'
audio.dependency 'yyaudiosdk', '3.3.211'
  ...
  s.subspec 'thunder_ai' do |audioai|
    ...
    audioai.dependency 'hydra/lite', '1.3.461'
audioai.dependency 'jobase/jobase', '1.3.34'
audioai.dependency 'transengine/transengine-audio', '3.3.207'
audioai.dependency 'yyaudiosdk/yyaudiosdk_ai', '3.3.211'
