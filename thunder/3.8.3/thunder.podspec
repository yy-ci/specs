Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thunder/3.8.3/thunder.zip" }
...
full.dependency 'yyaudiosdk', '3.8.1'
full.dependency 'yydec265', '1.0.17'
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.19.1'
...
full_static.dependency 'yyaudiosdk', '3.8.1'
full_static.dependency 'yydec265', '1.0.17'
full_static.dependency 'yyvideolib/yyvideolibsmallstatic_nobeauty', '100.19.1'
...
baidu_static_debug.dependency 'yyaudiosdk/yyaudiosdk_bd', '3.8.1'
baidu_static_debug.dependency 'yydec265', '1.0.17'
baidu_static_debug.dependency 'yyvideolib/yyvideolibstatic_bdsmall', '100.19.1'
...
fullai.dependency 'yyaudiosdk/yyaudiosdk_ai', '3.8.1'
fullai.dependency 'yydec265', '1.0.17'
fullai.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.19.1'
...
audio.dependency 'yyaudiosdk', '3.8.1'
...
audioai.dependency 'yyaudiosdk/yyaudiosdk_ai', '3.8.1'
