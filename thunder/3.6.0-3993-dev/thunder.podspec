Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thunder/3.6.0-3993-dev/thunder.zip" }
...
full.dependency 'transengine/transengine-full', '3.6.0-1546-dev'
full.dependency 'yyaudiosdk', '3.6.0-292-dev'
full.dependency 'yydec265', '1.0.17'
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.17.3-dev.2'
...
full_static.dependency 'transengine/transengine-full', '3.6.0-1546-dev'
full_static.dependency 'yyaudiosdk', '3.6.0-292-dev'
full_static.dependency 'yydec265', '1.0.17'
full_static.dependency 'yyvideolib/yyvideolibsmallstatic_nobeauty', '100.17.3-dev.2'
...
baidu_static_debug.dependency 'transengine/transengine-full', '3.6.0-1546-dev'
...
fullai.dependency 'transengine/transengine-full', '3.6.0-1546-dev'
fullai.dependency 'yyaudiosdk/yyaudiosdk_ai', '3.6.0-292-dev'
fullai.dependency 'yydec265', '1.0.17'
fullai.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.17.3-dev.2'
...
audio.dependency 'transengine/transengine-audio', '3.6.0-1546-dev'
...
audioai.dependency 'transengine/transengine-audio', '3.6.0-1546-dev'
