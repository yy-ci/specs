Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thunder/3.5.13-3970-dev/thunder.zip" }
...
full.dependency 'hydra/lite', '1.4.10'
full.dependency 'jobase/jobase-lite', '1.4.10'
full.dependency 'libyuv', '1.0.5'
full.dependency 'transengine/transengine-full', '3.5.11'
full.dependency 'yyaudiosdk', '3.5.10'
full.dependency 'yydec265', '1.0.17'
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.17.3'
...
full_static.dependency 'transengine/transengine-full', '3.5.11'
full_static.dependency 'yyaudiosdk', '3.5.10'
full_static.dependency 'yydec265', '1.0.17'
full_static.dependency 'yyvideolib/yyvideolibsmallstatic_nobeauty', '100.17.3'
  ...
  s.subspec 'thunderbolt_baidu' do |baidu_static|
    ...
    baidu_static.dependency 'hydra/lite', '1.4.10'
baidu_static.dependency 'jobase/jobase-lite', '1.4.10'
  ...
  s.subspec 'thunderbolt_baidu_debug' do |baidu_static_debug|
    ...
    baidu_static_debug.dependency 'hydra/lite', '1.4.10'
baidu_static_debug.dependency 'jobase/jobase-lite', '1.4.10'
baidu_static_debug.dependency 'transengine/transengine-full', '3.5.11'
baidu_static_debug.dependency 'yy264', '1.0.18'
baidu_static_debug.dependency 'yyaudiosdk/yyaudiosdk_bd', '3.5.10'
baidu_static_debug.dependency 'yydec265', '1.0.17'
baidu_static_debug.dependency 'yyvideolib/yyvideolibstatic_bdsmall', '100.17.3'
...
fullai.dependency 'hydra/lite', '1.4.10'
fullai.dependency 'jobase/jobase-lite', '1.4.10'
fullai.dependency 'libyuv', '1.0.5'
fullai.dependency 'transengine/transengine-full', '3.5.11'
fullai.dependency 'yyaudiosdk/yyaudiosdk_ai', '3.5.10'
fullai.dependency 'yydec265', '1.0.17'
fullai.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.17.3'
  ...
  s.subspec 'thunder' do |audio|
    ...
    audio.dependency 'hydra/lite', '1.4.10'
audio.dependency 'jobase/jobase-lite', '1.4.10'
audio.dependency 'transengine/transengine-audio', '3.5.11'
audio.dependency 'yyaudiosdk', '3.5.10'
  ...
  s.subspec 'thunder_ai' do |audioai|
    ...
    audioai.dependency 'hydra/lite', '1.4.10'
audioai.dependency 'jobase/jobase-lite', '1.4.10'
audioai.dependency 'transengine/transengine-audio', '3.5.11'
audioai.dependency 'yyaudiosdk/yyaudiosdk_ai', '3.5.10'
