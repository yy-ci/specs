Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://cirepo.bs2dl.yy.com/sdks/ios/thunder/3.3.213-3833-dev/thunder.zip" }
...
full.dependency 'hydra', '1.3.60-465-dev'
full.dependency 'jobase/jobase', '1.3.33'
full.dependency 'libyuv', '1.0.5'
full.dependency 'transengine/transengine-full', '3.3.203'
full.dependency 'yyaudiosdk', '3.3.208'
full.dependency 'yydec265', '1.0.17'
full.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.33.14'
...
full_static.dependency 'transengine/transengine-full', '3.3.203'
full_static.dependency 'yyaudiosdk', '3.3.208'
full_static.dependency 'yydec265', '1.0.17'
full_static.dependency 'yyvideolib/yyvideolibsmallstatic_nobeauty', '100.33.14'
  ...
  s.subspec 'thunderbolt_baidu' do |baidu_static|
    ...
    baidu_static.dependency 'hydra', '1.3.60-465-dev'
baidu_static.dependency 'jobase/jobase', '1.3.33'
...
fullai.dependency 'hydra', '1.3.60-465-dev'
fullai.dependency 'jobase/jobase', '1.3.33'
fullai.dependency 'libyuv', '1.0.5'
fullai.dependency 'transengine/transengine-full', '3.3.203'
fullai.dependency 'yyaudiosdk/yyaudiosdk_ai', '3.3.208'
fullai.dependency 'yydec265', '1.0.17'
fullai.dependency 'yyvideolib/yyvideolibstatic_nobeauty', '100.33.14'
  ...
  s.subspec 'thunder' do |audio|
    ...
    audio.dependency 'hydra', '1.3.60-465-dev'
audio.dependency 'jobase/jobase', '1.3.33'
audio.dependency 'transengine/transengine-audio', '3.3.203'
audio.dependency 'yyaudiosdk', '3.3.208'
  ...
  s.subspec 'thunder_ai' do |audioai|
    ...
    audioai.dependency 'hydra', '1.3.60-465-dev'
audioai.dependency 'jobase/jobase', '1.3.33'
audioai.dependency 'transengine/transengine-audio', '3.3.203'
audioai.dependency 'yyaudiosdk/yyaudiosdk_ai', '3.3.208'
